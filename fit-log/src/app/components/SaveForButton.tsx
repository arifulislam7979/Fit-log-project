...
const SaveForButton = ({data}:SaveButtonProps) => {
    ...
    return (
        <div>
            <button onClick={handleSaveButton} className="border border-zinc-800 hover:border-zinc-600 bg-zinc-900/50 hover:bg-zinc-900 text-zinc-300 font-semibold py-3 px-5 rounded-lg text-xs tracking-wide transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer active:scale-95">
